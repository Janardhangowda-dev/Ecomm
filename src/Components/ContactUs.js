    ...
    return (
      ...
      <form action="#" method="POST" className="contact-form" onSubmit={this.submitHandler}>
              <div className="form-group">
                ...
                <input type="text" id="First Name" name="participate" placeholder="Enter Your First Name" required onChange={this.changeHandler}/>
              </div>

              <div className="form-group">
                <label htmlFor="Last Name">Last Name:</label>
                <input type="text" id="Last Name" name="Last Name" placeholder="Enter Your Last Name" required onChange={this.changeHandler}/>
              </div>

              <div className="form-group">
                <label htmlFor="Your Email Id">Email ID:</label>
                <input type="text" id="Email Id" name="Email Id" placeholder="Enter Your Email Id" required onChange={this.changeHandler}/>
              </div>
