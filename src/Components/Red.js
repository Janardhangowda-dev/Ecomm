...
<main>
        ...
        <div className="product-info">
          ...
          <ul>
            ...
            <li><strong>Fabric:</strong> Taranga Pattu</li>
            <li><strong>Primary Color:</strong> Green</li>
            <li><strong>Secondary Color:</strong> Green</li>
            <li><strong>Material:</strong> Green</li>
            <li><strong>Pattern:</strong> Brocade</li>
            <li><strong>Border Type:</strong> Self Zari</li>
            <li><strong>Border Size:</strong> Medium</li>
            <li><strong>Color Family:</strong> Pastel</li>
            <li><strong>Type:</strong> Saree</li>
          </ul>
        </div>
